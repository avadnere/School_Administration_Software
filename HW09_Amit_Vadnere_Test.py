"""
Created on 2019-10-30 17:15:53
@author: Amit Vadnere
...
class TestRepository(unittest.TestCase):
    ...
    def test_file_reading_gen(self):
        ...
        self.assertEqual(list(repository.file_reading_gen(path="students.txt", fields=3)),
                         expected_case_1)
        with self.assertRaises(ValueError):
            list(repository.file_reading_gen(path="students.txt", fields=4))
